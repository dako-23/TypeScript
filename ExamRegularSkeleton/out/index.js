...
let roomB01 = new airconditionedRoom_js_1.AirconditionedRoom(200, 'B01');
let roomNumberB02 = 'B02';
let roomB02 = {
...
console.log(motel.addRoom(roomB01));
console.log(motel.getTotalBudget());
console.log(motel.bookRoom('B02', util_js_1.WinterMonth.December));
console.log(motel.addRoom(roomB02));
console.log(motel.bookRoom('B02', util_js_1.WinterMonth.December));
console.log(motel.getTotalBudget());
console.log(motel.bookRoom('A01', util_js_1.WinterMonth.December));
console.log(motel.bookRoom('A01', util_js_1.WinterMonth.December));
console.log(motel.bookRoom('B01', util_js_1.WinterMonth.February));
console.log(motel.getTotalBudget());
console.log(motel.cancelBooking('B02', util_js_1.WinterMonth.January));
console.log(motel.cancelBooking('B02', util_js_1.WinterMonth.December));
console.log(motel.cancelBooking('B01', util_js_1.WinterMonth.February));
console.log(motel.getTotalBudget());
// EXAMPLE 3
// let motel = new MonthlyMotel<SummerMonth>();
